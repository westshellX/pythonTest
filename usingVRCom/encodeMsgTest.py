...
def encodeMsgTest(courseValue,latValue,lonValue,mmsiValue)->str:
	print("Hello MsgTest")
	print(courseValue)
	# You do not need to pass every attribute to the class.
	# # All field other than `mmsi` do have default values.
	#course=219.3, lat=37.802, lon=-122.341, mmsi='366053209'
	msg = MessageType1.create(course=courseValue,lat=latValue,lon=lonValue,mmsi=mmsiValue)
	print(lonValue)
...
# You can also change the NMEA fields like the radio channel:
	msgStr=encode_msg(msg, radio_channel="B")
	print(msgStr)
	return msgStr

encodeMsgTest(219.3, 37.802, -122.341,'366053209')
